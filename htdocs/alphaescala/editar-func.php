...
<body>
    ...
    <section class="container">
          <?php include ("config.php");
            $sql = "SELECT * FROM funcionario WHERE matricula=".$_REQUEST["matricula"];
          ...
          <h1>Editar Funcionário</h1>
           <div class="divider"></div>
            <form action="crud-func.php?acao=editar&matricula=<?php print $row["matricula"]; ?>" method="POST">
                <div class="row">
                    <div class="input-field col s12 m4">
                        <label>Nome</label>
                        <input type="text" name="nome" class="field" value="<?php print $row["nome"]; ?>">
                    </div>
                    <div class="input-field col s12 m4">
                        <select name="profissao">
                          <option value="<?php echo($row['profissao']);?>" disabled selected>Escolha a profissão</option>
                ...
                <div class="row">
                    <div class="input-field col s12 m4">
                        ...
                        <input type="number" name="telefone" class="field" value="<?php print $row["telefone"]; ?>">
                    </div>
                    <div class="input-field col s12 m4">
                        <select value="" name="atividade">
                ...
                <div class="form-group">
                    ...
                    <button class='btn waves-effect waves-light' type="button" onclick="location='listar-func.php'">Voltar
